...
-- Parámetros:
--   p_product_id: UUID del proyecto (project_id)
--   p_name: Nombre del producto
--   p_description: Descripción del producto
--   p_language: Idioma del producto (default 'es')
--   p_tipo: Tipo de producto (default 'chatbot')
--   p_config: Configuración JSON del producto
--   p_welcome_message: Mensaje de bienvenida
--   p_label: Etiqueta corta del producto
--   p_label_color: Código de color para la etiqueta
--   p_max_users: Número máximo de usuarios (default 100)
--   p_is_active_rag: Flag para activar RAG
--   p_is_active_alerts: Flag para activar alertas
--   p_is_active_insight: Flag para activar insights
--   io_product_id: UUID del producto (INOUT - se genera si es NULL)
-- =====================================================
...
Genera automáticamente un UUID si no se proporciona y establece valores por defecto.';
